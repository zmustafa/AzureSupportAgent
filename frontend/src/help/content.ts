...
export const DESTINATIONS: Destination[] = [
  ...
  { label: "Settings · Connectors", path: "/admin/connectors", group: "Settings", icon: "🔌", keywords: "jira servicenow teams slack", adminOnly: true },
  ...
  { label: "Settings · General", path: "/admin/settings", group: "Settings", icon: "⚙️", adminOnly: true },
];
