...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  { term: "Proactive Support", short: "Dashboards that surface risk before you ask.", long: "The umbrella for Assessments, the three Coverage detectors, Identity, IAM, Retirement Radar, Telemetry Intelligence, Performance Profiler, Reservations Monitor, and the Evidence Locker." },
