...
export default function ChatView() {
  ...
  useEffect(() => {
    if (inAssessments || inIdentity || inCoverage || inTelemetry || inBackupDr || inEvidence || inRadar || inTeleIntel || inPerformance) setProactiveOpen(true);
  }, [inAssessments, inIdentity, inCoverage, inTelemetry, inBackupDr, inEvidence, inRadar, inTeleIntel, inPerformance]);
