...
| 📜 Governance | `/entra/governance` | Access reviews, entitlement expiry, lifecycle workflows, what is governed at all | [Governance]({{ site.baseurl }}/user-guide/governance-identity/entra-governance/) |
