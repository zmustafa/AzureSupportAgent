...
| Other proactive | `app/radar/`, `app/perfprofile/`, `app/teleintel/`, `app/reservations/`, `app/quota/`, `app/identity/`, `app/iam/`, `app/tagintel/`, `app/changeexplorer/`, `app/capability/`, `app/graph/`, `app/ownership/`, `app/netcheck/` | Same shape (collector + demo + cache). |
