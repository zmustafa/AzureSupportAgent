...
{% include screenshot.html file="core-assessment-overview.png" title="Review an assessment report before acting on its score" caption="Check scope and evidence completeness alongside the five pillar scores. This synthetic report was not generated by an executed assessment and is not certification or proof of backend persistence." %}
...
{% include screenshot.html file="core-assessment-compliance.png" title="Review framework mappings without mistaking coverage for certification" caption="The compliance view illustrates mapped control outcomes for the selected report. Its mappings and coverage are synthetic, not a live assessment or an independent audit." %}
...
{% include screenshot.html file="core-assessment-finding.png" title="Inspect affected resources, ownership, and proposed remediation" caption="Expand a finding to review its evidence and suggested next step before changing lifecycle state. The displayed resource, owner, and recommendation are illustrative; no assignment, waiver, ticket, or remediation was submitted." %}
